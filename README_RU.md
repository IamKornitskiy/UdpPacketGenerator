...
### 🚧 В активной разработке (v2.1.x)
- [ ] **CSV-поле** – проверка количества колонок
- [ ] **Визуальная подсветка ошибок** в текстовых редакторах при некорректных данных
- [ ] **NMEA-поле** с проверкой контрольной суммы

### 🔜 Планируется (v2.2.x и далее)
